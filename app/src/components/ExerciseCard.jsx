    ...
    return (
        ...
        bg-slate-950 sm:flex-wrap'>
            ...
            sm:items-center sm:flex-wrap gap-x-4'>
                ...
                max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:tex-center'>{exercise.name.replaceAll("_", " ")}</h2>
            ...
            <div className='flex flex-col bg-sl rounded gap-2'>
                ...
                {['reps', 'rest', 'tempo'].map(info => {
                    return (
                        ...
                        border-solid border-slate-900 w-full'>
                            <h3 clasName='capitalize text-slate-400 text-sm'>{info === 'reps' ? `${exercise.unit}` : info}</h3>
